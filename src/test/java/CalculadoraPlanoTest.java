...
class CalculadoraPlanoTest {

    @Test
    void contarTotalFilmesAssistidosMes() {
            ...
            assertEquals(4, CalculadoraPlano.contarTotalFilmesAssistidosMes(lista));
    ...
    void calculaPlano() {
        ...
        assertEquals(0, CalculadoraPlano.calculaPlano(usuario));
    }
}